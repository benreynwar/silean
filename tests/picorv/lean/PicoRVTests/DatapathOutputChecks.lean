...
namespace PicoRVTests.DatapathOutputChecks
...
example : Silean.BitVector.toNat 32 (evaluatedBranch.1 .reg_pc) = 0x1000 := by decide
example : Silean.BitVector.toNat 32 (evaluatedBranch.1 .reg_op1) = 7 := by decide
example : Silean.BitVector.toNat 32 (evaluatedBranch.1 .next_pc) = 0x3002 := by decide
example : Silean.BitVector.toNat 32 (evaluatedBranch.1 .cpuregs_wrdata) = 0x1004 := by decide
...
end PicoRVTests.DatapathOutputChecks
