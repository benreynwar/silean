...
namespace PicoRVTests.ControlContractChecks
...
example : Silean.BitVector.toNat 5 (evaluatedWriteback.1 .latched_rd) = 3 := by decide
...
example : PicoRV.Memory.CommandsWellFormed
...
end PicoRVTests.ControlContractChecks
