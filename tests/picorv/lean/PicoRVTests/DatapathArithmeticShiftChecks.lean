...
namespace PicoRVTests.DatapathArithmeticShiftChecks
...
example : Silean.BitVector.toNat 32 (evaluatedShift.1 .reg_op1) = 1 := by decide
...
example : Silean.BitVector.toNat 32 (arithmeticAfter1 .reg_op1) = 0xf8000000 := by decide
example : shiftAmount arithmeticAfter1 = 0 := by decide

end PicoRVTests.DatapathArithmeticShiftChecks
