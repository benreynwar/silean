...
namespace PicoRVTests.DatapathShiftChecks
...
example : Silean.BitVector.toNat 32 ((firstLeftStep 0) .reg_out) = 1 := by decide
example : Silean.BitVector.toNat 32 ((firstLeftStep 1) .reg_op1) = 2 := by decide
example : shiftAmount (firstLeftStep 1) = 0 := by decide
example : Silean.BitVector.toNat 32 ((firstLeftStep 3) .reg_op1) = 2 := by decide
example : shiftAmount (firstLeftStep 3) = 2 := by decide
example : Silean.BitVector.toNat 32 ((firstLeftStep 4) .reg_op1) = 16 := by decide
example : shiftAmount (firstLeftStep 4) = 0 := by decide
example : Silean.BitVector.toNat 32 ((firstLeftStep 5) .reg_op1) = 16 := by decide
example : shiftAmount (firstLeftStep 5) = 1 := by decide
example : Silean.BitVector.toNat 32 ((firstLeftStep 31) .reg_op1) = 16 := by decide
...
example : Silean.BitVector.toNat 32 (logicalRightAfter4 .reg_op1) = 0x08000001 := by decide
example : Silean.BitVector.toNat 32 (arithmeticRightAfter4 .reg_op1) = 0xf8000001 := by decide
example : Silean.BitVector.toNat 32 (leftWinsOverlap .reg_op1) = 0x00000100 := by decide
example : Silean.BitVector.toNat 32 (logicalWinsRightOverlap .reg_op1) = 0x08000001 := by decide
...
example : Silean.BitVector.toNat 32 (shift9After1 .reg_op1) = 16 := by decide
example : shiftAmount shift9After1 = 5 := by decide
example : Silean.BitVector.toNat 32 (shift9After2 .reg_op1) = 256 := by decide
example : shiftAmount shift9After2 = 1 := by decide
example : Silean.BitVector.toNat 32 (shift9After3 .reg_op1) = 512 := by decide
example : shiftAmount shift9After3 = 0 := by decide
example : Silean.BitVector.toNat 32 (shift9After4 .reg_out) = 512 := by decide

end PicoRVTests.DatapathShiftChecks
