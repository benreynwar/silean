...
namespace PicoRVTests.DatapathStandaloneChecks
...
example : Silean.BitVector.toNat 32 (resetCycle.1 .reg_pc) = 0x1000 := by decide
example : Silean.BitVector.toNat 32 (resetCycle.1 .reg_op1) = 3 := by decide
example : Silean.BitVector.toNat 32 (resetCycle.2 .reg_pc) = 0 := by decide
example : Silean.BitVector.toNat 32 (resetCycle.2 .reg_next_pc) = 0 := by decide
...
end PicoRVTests.DatapathStandaloneChecks
