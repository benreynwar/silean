...
namespace PicoRVTests.Boundary

open Silean

namespace P
namespace Control
abbrev Input := PicoRV.Control.Input
abbrev Output := PicoRV.Control.Output
abbrev inputMap := PicoRV.Control.inputMap
abbrev outputMap := PicoRV.Control.outputMap
end Control
namespace Datapath
abbrev Input := PicoRV.Datapath.Input
abbrev Output := PicoRV.Datapath.Output
abbrev inputMap := PicoRV.Datapath.inputMap
abbrev outputMap := PicoRV.Datapath.outputMap
end Datapath
namespace Decoder
abbrev Input := PicoRV.Decoder.Input
abbrev Output := PicoRV.Decoder.Output
abbrev inputMap := PicoRV.Decoder.inputMap
abbrev outputMap := PicoRV.Decoder.outputMap
end Decoder
namespace Memory
abbrev Input := PicoRV.Memory.Input
abbrev Output := PicoRV.Memory.Output
abbrev inputMap := PicoRV.Memory.inputMap
abbrev outputMap := PicoRV.Memory.outputMap
end Memory
namespace Regs
abbrev Input := PicoRV.Regs.Input
abbrev Output := PicoRV.Regs.Output
abbrev inputMap := PicoRV.Regs.inputMap
abbrev outputMap := PicoRV.Regs.outputMap
end Regs
end P
