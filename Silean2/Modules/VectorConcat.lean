...
namespace Silean2.Modules.VectorConcat
...
end Silean2.Modules.VectorConcat

namespace Silean2.Modules.VectorConcat.Naming
...
def namingWith (element : SignalType) (leftWidth rightWidth : Nat)
  ...
  .composite
    ...
    (fun
      ...
      | .combine => "combine")
    (fun
      | .leftSplit => Silean2.Naming.SignalAdapter.splitterWithNaming
          (.vector leftWidth element) (.vector elementNaming)
      | .rightSplit => Silean2.Naming.SignalAdapter.splitterWithNaming
          (.vector rightWidth element) (.vector elementNaming)
      | .combine => Silean2.Naming.SignalAdapter.combinerWithNaming
...
end Silean2.Modules.VectorConcat.Naming
