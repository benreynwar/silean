...
namespace Silean2.Modules.Constant
...
end Silean2.Modules.Constant

namespace Silean2.Modules.Constant.Naming
...
def namingWith : (signalType : SignalType) → (value : signalType.Denote) →
  ...
  | .bit, value, typeNaming => by
      ...
      exact .composite
        ...
        (fun | .source => "source")
        (fun | .source => Silean2.Naming.Primitive.constant value)
  | .vector length element, value, typeNaming => by
      ...
      exact .composite
        ...
        (fun
          ...
          | .combiner .output =>
              Silean2.Naming.SignalAdapter.combinerWithNaming splitter.combiner
                typeNaming)
...
end Silean2.Modules.Constant.Naming
