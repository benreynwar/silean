...
namespace Silean2.Modules.CombMuxTree
...
end Silean2.Modules.CombMuxTree

namespace Silean2.Modules.CombMuxTree.Naming
      ...
      exact .composite
        ...
        (fun
          | Modules.CombMuxTree.BaseInstance.split =>
              Silean2.Naming.SignalAdapter.splitterWithNaming
...
end Silean2.Modules.CombMuxTree.Naming
