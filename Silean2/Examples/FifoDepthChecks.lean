...
namespace Silean2.Examples.FifoDepthChecks

open Silean2 Silean2.Modules Silean2.FIRRTL
...
#guard containsAll
  (renderCircuit (FifoNaming.depthNamingWith payloadType payloadNaming 3 (by omega)))
...
end Silean2.Examples.FifoDepthChecks
