...
def notOutputRule : Contracts.Cycle.CycleOutputRule not.ports emptySignalMap
...
@[simp] theorem notOutputRule_holds_iff
  ...
  simp [notOutputRule, Contracts.Cycle.CycleOutputRule.Holds, SignalSelection.project,
