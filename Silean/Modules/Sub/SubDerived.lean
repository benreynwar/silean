...
import Silean.Modules.Sub.Internal.SubVerification

/-! Public placement and correctness declarations for structural subtraction. -/
...
/-- One-bit-extended equal-width signed subtraction preserves the exact
integer difference rather than wrapping it. -/
theorem resultValue_toInt_signed_extended (width : Nat)
  ...
  · simpa [Arithmetic.resultWidth] using
      (Arithmetic.Internal.signed_sub_bounds_extended width
