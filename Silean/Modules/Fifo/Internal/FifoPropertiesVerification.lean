...
namespace Silean.Modules.Fifo.Properties.Internal

open Silean Silean.Interfaces.Fifo

/-! Proof implementation for the pointer FIFO's logical queue view. -/
...
end Silean.Modules.Fifo.Properties.Internal
