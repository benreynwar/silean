...
example : BitVector.toNat 4 (formattedWriteMask (byteLane 0)) = 0x1 := by decide
example : BitVector.toNat 4 (formattedWriteMask (byteLane 1)) = 0x2 := by decide
example : BitVector.toNat 4 (formattedWriteMask (byteLane 2)) = 0x4 := by decide
example : BitVector.toNat 4 (formattedWriteMask (byteLane 3)) = 0x8 := by decide
example : BitVector.toNat 32 (formattedReadData (byteLane 0)) = 0x11 := by decide
example : BitVector.toNat 32 (formattedReadData (byteLane 1)) = 0x22 := by decide
example : BitVector.toNat 32 (formattedReadData (byteLane 2)) = 0x33 := by decide
example : BitVector.toNat 32 (formattedReadData (byteLane 3)) = 0x44 := by decide
...
example : BitVector.toNat 4 (formattedWriteMask totalizedWordSize) = 0xf := by decide
...
example : BitVector.toNat 32 (resetTransfer .mem_rdata_q) = 0x00510093 := by decide
...
example : BitVector.toNat 32 (trapTransfer .mem_rdata_q) = 0x00510093 := by decide
...
example : BitVector.toNat 32 (overlappingRequest .mem_addr) = 0x4000 := by decide
example : BitVector.toNat 32 (overlappingRequest .mem_wdata) = 0xaaaaaaaa := by decide
example : BitVector.toNat 4 (overlappingRequest .mem_wstrb) = 0 := by decide
