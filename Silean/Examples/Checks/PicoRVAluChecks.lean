...
open Silean Silean.FIRRTL Silean.Examples.PicoRV
...
#guard BitVector.toNat 32 (Alu.aluOut addInputs) == 16
#guard BitVector.toNat 32 (Alu.aluOut subtractInputs) == 2 ^ 32 - 2
#guard Alu.comparisonOutput signedLessInputs
#guard Alu.aluOut signedLessInputs 0
#guard !(Alu.aluOut signedLessInputs 1)
#guard BitVector.toNat 32 (Alu.aluOut (base (Alu.wordOfNat 7) (Alu.wordOfNat 9))) == 0
...
end Silean.Examples.Checks.PicoRVAlu
