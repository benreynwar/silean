...
example : BitVector.toNat 32 (afterUntakenBranch .reg_pc) = 0x2000 := by decide
example : BitVector.toNat 32 (afterUntakenBranch .reg_next_pc) = 0x2004 := by decide
...
example : BitVector.toNat 32 (afterLoadBase .reg_op1) = 0x1200 := by decide
example : BitVector.toNat 32 (afterLoadBase .reg_op2) = 17 := by decide
...
example : BitVector.toNat 32 (afterIllegalLoad .reg_op1) = 13 := by decide
example : BitVector.toNat 32 (afterIllegalLoad .reg_op2) = 17 := by decide
...
example : BitVector.toNat 32 (trappedLui .reg_op1) = 13 := by decide
example : BitVector.toNat 32 (trappedLui .reg_op2) = 17 := by decide
example : BitVector.toNat 32 (trappedImmediateShift .reg_op1) = 13 := by decide
example : shiftAmount trappedImmediateShift = 9 := by decide
example : BitVector.toNat 32 (trappedImmediateAlu .reg_op1) = 13 := by decide
example : BitVector.toNat 32 (trappedImmediateAlu .reg_op2) = 17 := by decide
example : BitVector.toNat 32 (trappedFallback .reg_op1) = 13 := by decide
example : BitVector.toNat 32 (trappedFallback .reg_op2) = 17 := by decide
