...
import Silean.Examples.PicoRV.Control.Internal.ControlExecuteTransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlFetchTransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlLoadTransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlLoadRs1TransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlLoadRs2TransitionVerification
...
import Silean.Examples.PicoRV.Control.Internal.ControlStoreTransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlShiftTransitionVerification
import Silean.Examples.PicoRV.Control.Internal.ControlTrapTransitionVerification
...
private theorem implements :
  ...
  have defaultValue : hierStep.childOutputs .defaultTransition .value =
    ...
    have equation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      ...
      ((childMatch .defaultTransition).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
  ...
  have clearValue : hierStep.childOutputs .clearCommands .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .clearCommands).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
