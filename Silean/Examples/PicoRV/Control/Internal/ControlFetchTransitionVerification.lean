...
private theorem implements :
  ...
  have wordSizeValue := (Modules.Constant.outputRule_holds_iff
    ...
    ((childMatch .wordSize).ruleHolds Primitives.ConstantRule.apply)
  have loadRs1Value := (Modules.Constant.outputRule_holds_iff
    (.vector 8 .bit) (stateBits cpuStateLdRs1) _ _ _).mp
    ((childMatch .loadRs1State).ruleHolds Primitives.ConstantRule.apply)
  have notDecoderValue : hierStep.childOutputs .notDecoder .output =
    ...
    have equation := (Primitives.notOutputRule_holds_iff _ _ _).mp
      ((childMatch .notDecoder).ruleHolds Primitives.NotRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have notJalrValue : hierStep.childOutputs .notJalr .output =
    ...
    have equation := (Primitives.notOutputRule_holds_iff _ _ _).mp
      ((childMatch .notJalr).ruleHolds Primitives.NotRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have commonValue : hierStep.childOutputs .commonState .value =
    ...
    have equation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      stateMap _ _ _).mp
      ((childMatch .commonState).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
  ...
  have commonFieldsValue : hierStep.childOutputs .commonFields =
    ...
    have equation := (Modules.NamedTupleSplitter.outputRule_holds_iff
      stateMap _ _ _).mp
      ((childMatch .commonFields).ruleHolds Modules.NamedTupleSplitter.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans <| (congrArg
      (Modules.NamedTupleSplitter.splitValue stateMap) commonValue).trans
        (Modules.NamedTupleSplitter.splitValue_pack _ _)
  ...
  have jalValue : hierStep.childOutputs .jalState .value =
    ...
    have equation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      stateMap _ _ _).mp
      ((childMatch .jalState).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
  ...
  have ordinaryValue : hierStep.childOutputs .ordinaryState .value =
    ...
    have equation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      stateMap _ _ _).mp
      ((childMatch .ordinaryState).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
