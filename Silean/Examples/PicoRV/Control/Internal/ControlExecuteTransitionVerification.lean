...
private theorem implements :
  ...
  have zeroRdValue := (Modules.Constant.outputRule_holds_iff
    ...
    ((childMatch .zeroRd).ruleHolds Primitives.ConstantRule.apply)
  ...
  have branchDecoderValue : hierStep.childOutputs .branchDecoder .result =
    ...
    have equation := (Modules.BitMux.selectRule_holds_iff _ _ _).mp
      ((childMatch .branchDecoder).ruleHolds Modules.BitMux.Rule.select)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have branchStateValue : hierStep.childOutputs .branchState .value =
    ...
    have equation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      stateMap _ _ _).mp
      ((childMatch .branchState).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
