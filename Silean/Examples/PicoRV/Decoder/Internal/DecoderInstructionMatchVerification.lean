...
import Silean.Examples.PicoRV.Decoder.DecoderInstructionFieldsTheorems
import Silean.Examples.PicoRV.Decoder.DecoderInstructionMatchGateTheorems
...
private theorem implements :
  ...
  have immediateShiftValue : hierStep.childOutputs .immediateShiftGroup .output =
    ...
    have shiftPartial := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .immediateShift01).ruleHolds Primitives.OrRule.apply)
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .immediateShiftGroup).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have immediateArithmeticValue :
    ...
    have pair01 := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmetic01).ruleHolds Primitives.OrRule.apply)
    ...
    have pair23 := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmetic23).ruleHolds Primitives.OrRule.apply)
    ...
    have pair45 := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmetic45).ruleHolds Primitives.OrRule.apply)
    ...
    have firstFour := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmetic0123).ruleHolds Primitives.OrRule.apply)
    ...
    have firstSix := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmetic012345).ruleHolds Primitives.OrRule.apply)
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .immediateArithmeticGroup).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have registerShiftValue : hierStep.childOutputs .registerShiftGroup .output =
    ...
    have registerPartial := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .registerShift01).ruleHolds Primitives.OrRule.apply)
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .registerShiftGroup).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
