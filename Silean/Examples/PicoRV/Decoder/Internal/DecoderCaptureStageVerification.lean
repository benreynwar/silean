...
private theorem implements :
  ...
  have captureEnableValue : hierStep.childOutputs .captureEnable .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((coveredMatch .captureEnable).ruleHolds Primitives.AndRule.apply)
  ...
  have resetValue : hierStep.childOutputs .reset .output = !hierStep.inputs .resetn := by
    have equation := (Primitives.notOutputRule_holds_iff _ _ _).mp
      ((coveredMatch .reset).ruleHolds Primitives.NotRule.apply)
    simpa [body, wiring, context,
      EndpointContext.moduleInput, SignalSource.value] using equation
  have opcodeValue : hierStep.childOutputs .opcode .result =
    ...
    have equation := (Modules.VectorSlice.outputRule_holds_iff .bit 0 7 25 _ _ _).mp
      ((coveredMatch .opcode).ruleHolds Modules.VectorSlice.Rule.apply)
  ...
  have funct3Value : hierStep.childOutputs .funct3 .result =
    ...
    have equation := (Modules.VectorSlice.outputRule_holds_iff .bit 12 3 17 _ _ _).mp
      ((coveredMatch .funct3).ruleHolds Modules.VectorSlice.Rule.apply)
  ...
  have decodedRdValue : hierStep.childOutputs .decodedRd .result =
    ...
    have equation := (Modules.VectorSlice.outputRule_holds_iff .bit 7 5 20 _ _ _).mp
      ((coveredMatch .decodedRd).ruleHolds Modules.VectorSlice.Rule.apply)
  ...
  have decodedRs1Value : hierStep.childOutputs .decodedRs1 .result =
    ...
    have equation := (Modules.VectorSlice.outputRule_holds_iff .bit 15 5 12 _ _ _).mp
      ((coveredMatch .decodedRs1).ruleHolds Modules.VectorSlice.Rule.apply)
  ...
  have decodedRs2Value : hierStep.childOutputs .decodedRs2 .result =
    ...
    have equation := (Modules.VectorSlice.outputRule_holds_iff .bit 20 5 7 _ _ _).mp
      ((coveredMatch .decodedRs2).ruleHolds Modules.VectorSlice.Rule.apply)
  ...
  have opcodeLuiValue : hierStep.childOutputs .opcodeLui .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x37) _ _ _).mp
        ((coveredMatch .opcodeLui).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x37)) opcodeValue)
  have opcodeAuipcValue : hierStep.childOutputs .opcodeAuipc .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x17) _ _ _).mp
        ((coveredMatch .opcodeAuipc).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x17)) opcodeValue)
  have opcodeJalValue : hierStep.childOutputs .opcodeJal .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x6f) _ _ _).mp
        ((coveredMatch .opcodeJal).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x6f)) opcodeValue)
  have opcodeJalrValue : hierStep.childOutputs .opcodeJalr .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x67) _ _ _).mp
        ((coveredMatch .opcodeJalr).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x67)) opcodeValue)
  have opcodeBranchValue : hierStep.childOutputs .opcodeBranch .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x63) _ _ _).mp
        ((coveredMatch .opcodeBranch).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x63)) opcodeValue)
  have opcodeLoadValue : hierStep.childOutputs .opcodeLoad .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x03) _ _ _).mp
        ((coveredMatch .opcodeLoad).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x03)) opcodeValue)
  have opcodeStoreValue : hierStep.childOutputs .opcodeStore .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x23) _ _ _).mp
        ((coveredMatch .opcodeStore).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x23)) opcodeValue)
  have opcodeAluImmValue : hierStep.childOutputs .opcodeAluImm .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x13) _ _ _).mp
        ((coveredMatch .opcodeAluImm).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x13)) opcodeValue)
  have opcodeAluRegValue : hierStep.childOutputs .opcodeAluReg .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 7 .bit) (bits 7 0x33) _ _ _).mp
        ((coveredMatch .opcodeAluReg).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 7 .bit).equal value (bits 7 0x33)) opcodeValue)
  have funct3ZeroValue : hierStep.childOutputs .funct3Zero .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      (.vector 3 .bit) (bits 3 0) _ _ _).mp
        ((coveredMatch .funct3Zero).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation.trans (congrArg (fun value =>
      (SignalType.vector 3 .bit).equal value (bits 3 0)) funct3Value)
  have jalrValue : hierStep.childOutputs .jalr .output =
      (matchesBits 7 0x67 (opcodeBits (hierStep.inputs .mem_rdata_latched)) &&
        matchesBits 3 0 (funct3Bits (hierStep.inputs .mem_rdata_latched))) := by
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((coveredMatch .jalr).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have immediateValue : hierStep.childOutputs .immediate .output =
    ...
    have equation := Modules.VectorLayout.output_of_allowed 32 32
  ...
  have storedNextValue : hierStep.childOutputs .storedNext .value =
    ...
    have valueEquation := (Modules.NamedTupleCombiner.outputRule_holds_iff
      storedMap _ _ _).mp
      ((coveredMatch .storedNext).ruleHolds Modules.NamedTupleCombiner.Rule.apply)
    normalize_child_hyp valueEquation
    simp only [wiring, context, EndpointContext.moduleInput,
      EndpointContext.instanceOutput] at valueEquation
  ...
  have storedCurrent : hierStep.childOutputs .stored .q = storedValue contractState := by
    exact (Modules.EnabledRegister.observeRule_holds_iff storedType _ _ _).mp
      (storedMatch.ruleHolds Modules.EnabledRegister.Rule.observe)
  have storedOutputsValue : hierStep.childOutputs .storedOutputs =
    ...
    have equation := (Modules.NamedTupleSplitter.outputRule_holds_iff
      storedMap _ _ _).mp
      ((coveredMatch .storedOutputs).ruleHolds Modules.NamedTupleSplitter.Rule.apply)
  ...
  have branchCurrent : hierStep.childOutputs .branch .value =
    ...
    exact Modules.EnabledResetRegister.value_of_allowed branchMatch.allowed
