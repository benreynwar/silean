...
import Silean.Examples.PicoRV.Datapath.Internal.DatapathNextVerification
...
private theorem implements :
  ...
  have branchValue : hierStep.childOutputs .branchActive .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      (branchMatch.ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
