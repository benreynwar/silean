...
private theorem implements :
  ...
  have amountSplit := (amountSplitter.outputRule_holds_iff _ _ _).mp
    ((childMatch .amountBits).ruleHolds Composition.SignalComponentRule.apply)
  ...
  have high23Value : hierStep.childOutputs .amountHigh23 .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .amountHigh23).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have geFourValue : hierStep.childOutputs .amountGeFour .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .amountGeFour).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have zeroValue : hierStep.childOutputs .amountZero .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      ...
      ((childMatch .amountZero).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have leftSelectValue : hierStep.childOutputs .leftSelect .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .leftSelect).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have logicalSelectValue : hierStep.childOutputs .logicalSelect .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .logicalSelect).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have arithmeticSelectValue : hierStep.childOutputs .arithmeticSelect .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .arithmeticSelect).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have oneValue := (Modules.Constant.outputRule_holds_iff
    ...
    ((childMatch .one).ruleHolds Primitives.ConstantRule.apply)
  ...
  have stepValue : hierStep.childOutputs .selectedStep .result =
    ...
    have equation := Modules.Mux.result_of_allowed (.vector 5 .bit)
  ...
  have subtractValue : hierStep.childOutputs .subtractStep .result =
    ...
    have equation :=
      (Modules.AddSub.Behavior.of_allowed 5
  ...
  have resultInputs : body.wiring.childInputValues hierStep.inputs
    ...
    · cases field
      · change hierStep.childOutputs .updatedFields .reg_pc = _
        simpa [structuralState, zero, SignalMap.set] using
      ...
      · change hierStep.childOutputs .selectedOp1 .result = _
        simpa [structuralState, zero, SignalMap.set] using selectedOp1Value
      ...
      · change hierStep.childOutputs .selectedResult .result = _
        simpa [structuralState, zero, SignalMap.set] using selectedResultValue
      · change hierStep.childOutputs .selectedShift .result = _
        simpa [structuralState, zero, SignalMap.set] using selectedShiftValue
