...
private theorem implements :
  ...
  have progressValue : hierStep.childOutputs .progress .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .progress).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have notActiveValue : hierStep.childOutputs .notActive .output =
    ...
    have equation := (Primitives.notOutputRule_holds_iff _ _ _).mp
      ((childMatch .notActive).ruleHolds Primitives.NotRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have loadDoneLeftValue : hierStep.childOutputs .loadDoneLeft .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((childMatch .loadDoneLeft).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have loadDoneValue : hierStep.childOutputs .loadDone .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((childMatch .loadDone).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
...
private theorem implements :
  ...
  have isLoadValue := (Modules.Constant.outputRule_holds_iff .bit false _ _ _).mp
    ((childMatch .isLoad).ruleHolds Primitives.ConstantRule.apply)
