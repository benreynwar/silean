...
def ShiftUpdate.amountSplitter : Composition.SignalSplitter := .vector 5 .bit
...
module_design ShiftUpdate (name := "picorv32_datapath_shift_update") where
  ...
  instances {
    ...
    amountHigh23 := Primitives.orDesign,
    amountGeFour := Primitives.orDesign,
    amountZero := Modules.EqualsConstant.design (.vector 5 .bit)
      (fiveBitsOfNat 0),
    leftSelect := Primitives.orDesign,
    logicalSelect := Primitives.orDesign,
    arithmeticSelect := Primitives.orDesign,
    trueBit := Modules.Constant.design .bit true,
    leftOne := Modules.VectorLayout.design 32 32 (ShiftUpdate.leftLayout 1),
    leftFour := Modules.VectorLayout.design 32 32 (ShiftUpdate.leftLayout 4),
    logicalOne := Modules.VectorLayout.design 32 32
      (ShiftUpdate.rightLogicalLayout 1),
    logicalFour := Modules.VectorLayout.design 32 32
      (ShiftUpdate.rightLogicalLayout 4),
    arithmeticOne := Modules.VectorLayout.design 32 32
      (ShiftUpdate.rightArithmeticLayout 1),
    arithmeticFour := Modules.VectorLayout.design 32 32
      (ShiftUpdate.rightArithmeticLayout 4),
    selectedLeft := Modules.Mux.design (.vector 32 .bit),
    selectedLogical := Modules.Mux.design (.vector 32 .bit),
    selectedArithmetic := Modules.Mux.design (.vector 32 .bit),
    selectArithmetic := Modules.Mux.design (.vector 32 .bit),
    selectLogical := Modules.Mux.design (.vector 32 .bit),
    selectLeft := Modules.Mux.design (.vector 32 .bit),
    one := Modules.Constant.design (.vector 5 .bit) (fiveBitsOfNat 1),
    four := Modules.Constant.design (.vector 5 .bit) (fiveBitsOfNat 4),
    selectedStep := Modules.Mux.design (.vector 5 .bit),
    subtractStep := Modules.AddSub.design 5,
    selectedOp1 := Modules.Mux.design (.vector 32 .bit),
    selectedShift := Modules.Mux.design (.vector 5 .bit),
    selectedResult := Modules.Mux.design (.vector 32 .bit),
