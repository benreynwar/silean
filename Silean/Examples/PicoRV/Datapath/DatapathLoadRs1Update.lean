...
module_design LoadRs1Update (name := "picorv32_datapath_load_rs1_update") where
  ...
  instances {
    ...
    lowFiveRs2 := Modules.VectorLayout.design 32 5 LoadRs1Update.lowFiveLayout,
    luiOperand := Modules.Mux.design (.vector 32 .bit),
    selectedOp1 := Modules.Mux.design (.vector 32 .bit),
    trapOp1 := Modules.Mux.design (.vector 32 .bit),
    op2Immediate := Modules.Mux.design (.vector 32 .bit),
    op2Shift := Modules.Mux.design (.vector 32 .bit),
    op2Load := Modules.Mux.design (.vector 32 .bit),
    op2Lui := Modules.Mux.design (.vector 32 .bit),
    trapOp2 := Modules.Mux.design (.vector 32 .bit),
    shiftImmediate := Modules.Mux.design (.vector 5 .bit),
    shiftLoad := Modules.Mux.design (.vector 5 .bit),
    shiftLui := Modules.Mux.design (.vector 5 .bit),
    trapShift := Modules.Mux.design (.vector 5 .bit),
    finalShift := Modules.Mux.design (.vector 5 .bit),
