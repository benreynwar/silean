...
module_design Next (name := "picorv32_datapath_next") where
  ...
  instances {
    ...
    selectLoad := Modules.Mux.design stateType,
    selectStore := Modules.Mux.design stateType,
    selectShift := Modules.Mux.design stateType,
    selectExecute := Modules.Mux.design stateType,
    selectLoadRs2 := Modules.Mux.design stateType,
    selectLoadRs1 := Modules.Mux.design stateType,
    selectFetch := Modules.Mux.design stateType,
