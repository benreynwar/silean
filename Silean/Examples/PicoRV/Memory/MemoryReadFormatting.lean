...
module_design ReadFormatting (name := "picorv32_memory_read_formatting") where
  ...
  instances {
    lowBit := Modules.VectorSlice.design .bit 0 1 31,
    highBit := Modules.VectorSlice.design .bit 1 1 30,
    lowLane := Modules.EqualsConstant.design (.vector 1 .bit) (fun _ => true),
    highLane := Modules.EqualsConstant.design (.vector 1 .bit) (fun _ => true),
    halfLow := Modules.VectorLayout.design 32 32
      (ReadFormatting.halfLayout false),
    halfHigh := Modules.VectorLayout.design 32 32
      (ReadFormatting.halfLayout true),
    byte0 := Modules.VectorLayout.design 32 32
      ReadFormatting.byte0Layout,
    byte1 := Modules.VectorLayout.design 32 32
      ReadFormatting.byte1Layout,
    byte2 := Modules.VectorLayout.design 32 32
      ReadFormatting.byte2Layout,
    byte3 := Modules.VectorLayout.design 32 32
      ReadFormatting.byte3Layout,
    halfValue := Modules.Mux.design (.vector 32 .bit),
    lowByteValue := Modules.Mux.design (.vector 32 .bit),
    highByteValue := Modules.Mux.design (.vector 32 .bit),
    byteValue := Modules.Mux.design (.vector 32 .bit),
    ...
    selectHalf := Modules.Mux.design (.vector 32 .bit),
    selectByte := Modules.Mux.design (.vector 32 .bit) }
  wiring {
