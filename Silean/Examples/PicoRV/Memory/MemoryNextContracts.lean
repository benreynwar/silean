...
def outputValues (inputs : inputMap.Values) : outputMap.Values
  | .idle => decide (BitVector.toNat 2 (inputs .mem_state) = 0)
  | .read => decide (BitVector.toNat 2 (inputs .mem_state) = 1)
  | .write => decide (BitVector.toNat 2 (inputs .mem_state) = 2)
  | .prefetched => decide (BitVector.toNat 2 (inputs .mem_state) = 3)
