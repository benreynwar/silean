...
private theorem implements :
  ...
  have enabledValue : hierStep.childOutputs .enabledIdle .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((childMatch .enabledIdle).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have instructionValue : hierStep.childOutputs .instructionCommand .output =
    ...
    have equation := (Primitives.orOutputRule_holds_iff _ _ _).mp
      ((childMatch .instructionCommand).ruleHolds Primitives.OrRule.apply)
    normalize_child_hyp equation unfolding wiring, context
    exact equation
  ...
  have readOutputValue : hierStep.childOutputs .read .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((childMatch .read).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have writeOutputValue : hierStep.childOutputs .write .output =
    ...
    have equation := (Primitives.andOutputRule_holds_iff _ _ _).mp
      ((childMatch .write).ruleHolds Primitives.AndRule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have highHalfValue : hierStep.childOutputs .highHalf .result =
    ...
    have equation := (Modules.EqualsConstant.outputRule_holds_iff
      ...
      ((childMatch .highHalf).ruleHolds Modules.EqualsConstant.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
  ...
  have byteMaskValue : hierStep.childOutputs .byteMask .result =
    ...
    have equation := (Modules.BinaryToOneHot.outputRule_holds_iff 2 _ _ _).mp
      ((childMatch .byteMask).ruleHolds Modules.BinaryToOneHot.Rule.apply)
    normalize_child_hyp equation unfolding wiring, context
