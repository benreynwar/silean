...
def decidableEq {body : ModuleBody} {children : Children body} :
  ...
  letI : DecidableEq body.context.instances.Name :=
    body.context.instances.names.decidableEq
...
def writes {body : ModuleBody} {children : Children body}
    ...
    List (body.context.instances.ports occurrence.child).outputs.Label :=
...
def reads {body : ModuleBody} {children : Children body}
    (occurrence : RuleOccurrence children) :
    List (body.context.instances.ports occurrence.child).inputs.Label :=
...
def outputAvailable {body : ModuleBody} {children : Children body}
    ...
    (child : body.context.instances.Name)
    (output : (body.context.instances.ports child).outputs.Label) : Prop :=
...
def sourceAvailable {body : ModuleBody} {children : Children body}
    ...
    (available : Availability children)
    (source : SignalSource body.context.ports body.context.instances signalType) : Prop :=
  match source with
...
theorem source_value_eq_of_available
    ...
    (source : SignalSource body.context.ports body.context.instances signalType)
...
theorem outputAvailable_mono {body : ModuleBody} {children : Children body}
    ...
    {child : body.context.instances.Name}
    {output : (body.context.instances.ports child).outputs.Label}
