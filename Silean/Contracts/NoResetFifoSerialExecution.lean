...
theorem run_decomposes
  ...
  | cons input inputs induction =>
      ...
      refine ⟨?_, ?_, ?_⟩
      · simp only [Silean.Execution.Model.run, childInputLists]
...
namespace Silean.Contracts.NoResetFifo.View.Execution
...
end Silean.Contracts.NoResetFifo.View.Execution
