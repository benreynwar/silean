...
signal_schema DatapathState where
  ...
  reg_next_pc : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit,
  ...
  reg_out : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit,
  reg_sh : Silean.Authoring.SignalSchema.vector 5 Silean.Authoring.SignalSchema.bit,
  alu_out_q : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit
...
signal_schema DatapathInputs where
  ...
  instr_sub : Silean.Authoring.SignalSchema.bit,
  instr_beq : Silean.Authoring.SignalSchema.bit,
  instr_bne : Silean.Authoring.SignalSchema.bit,
  instr_bge : Silean.Authoring.SignalSchema.bit,
  instr_bgeu : Silean.Authoring.SignalSchema.bit,
  instr_xori : Silean.Authoring.SignalSchema.bit,
  instr_xor : Silean.Authoring.SignalSchema.bit,
  instr_ori : Silean.Authoring.SignalSchema.bit,
  instr_or : Silean.Authoring.SignalSchema.bit,
  instr_andi : Silean.Authoring.SignalSchema.bit,
  instr_and : Silean.Authoring.SignalSchema.bit,
  instr_slli : Silean.Authoring.SignalSchema.bit,
  instr_srli : Silean.Authoring.SignalSchema.bit,
  instr_srai : Silean.Authoring.SignalSchema.bit,
  instr_sll : Silean.Authoring.SignalSchema.bit,
  instr_srl : Silean.Authoring.SignalSchema.bit,
  instr_sra : Silean.Authoring.SignalSchema.bit,
  ...
  is_lui_auipc_jal_jalr_addi_add_sub : Silean.Authoring.SignalSchema.bit,
  is_slti_blt_slt : Silean.Authoring.SignalSchema.bit,
  is_sltiu_bltu_sltu : Silean.Authoring.SignalSchema.bit,
  is_compare : Silean.Authoring.SignalSchema.bit,
  decoded_imm : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit,
  ...
  cpuregs_rs1 : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit,
  cpuregs_rs2 : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit,
  mem_done : Silean.Authoring.SignalSchema.bit,
  mem_rdata_word : Silean.Authoring.SignalSchema.vector 32 Silean.Authoring.SignalSchema.bit
...
def stateNumber (inputs : Inputs) : Nat := Silean.BitVector.toNat 8 inputs.cpu_state
def shiftAmount (state : stateMap.Values) : Nat := Silean.BitVector.toNat 5 (state .reg_sh)
...
def addWords (left right : Word) : Word :=
  wordOfNat (Silean.BitVector.toNat 32 left + Silean.BitVector.toNat 32 right)
...
@[reducible] private def nextPcInputs : SignalGroup inputMap :=
  Silean.SignalGroup.fromLabels inputMap NextPcRule.Input fun
    | .latched_store => .latched_store
    | .latched_branch => .latched_branch

@[reducible] private def nextPcOutputs : SignalGroup outputMap :=
  Silean.SignalGroup.fromLabels outputMap NextPcRule.Output fun
    | .next_pc => .next_pc

@[reducible] private def comparisonInputs : SignalGroup inputMap :=
  Silean.SignalGroup.fromLabels inputMap ComparisonRule.Input fun
    | .instr_sub => .instr_sub
    | .instr_beq => .instr_beq
    | .instr_bne => .instr_bne
    | .instr_bge => .instr_bge
...
@[reducible] private def comparisonOutputs : SignalGroup outputMap :=
  Silean.SignalGroup.fromLabels outputMap ComparisonRule.Output fun
    | .alu_out_0 => .alu_out_0

@[reducible] private def writebackInputs : SignalGroup inputMap :=
  Silean.SignalGroup.fromLabels inputMap WritebackRule.Input fun
    | .cpu_state => .cpu_state
    | .latched_store => .latched_store
...
@[reducible] private def writebackOutputs : SignalGroup outputMap :=
  Silean.SignalGroup.fromLabels outputMap WritebackRule.Output fun
...
def nextPcRule : Silean.Contracts.Cycle.CycleOutputRule ports stateMap where
...
def comparisonRule : Silean.Contracts.Cycle.CycleOutputRule ports stateMap where
...
def writebackRule : Silean.Contracts.Cycle.CycleOutputRule ports stateMap where
  readsInputs := writebackInputs
  writesOutputs := writebackOutputs
  target inputs state := fun
    | .cpuregs_wrdata =>
      writebackFrom (Silean.BitVector.toNat 8 (inputs .cpu_state))
...
@[simp] theorem nextPcRule_holds_iff (inputs : inputMap.Values)
  ...
  simp only [Silean.Contracts.Cycle.CycleOutputRule.Holds, nextPcRule,
    Silean.SignalGroup.fromLabels_matches_iff]
  constructor
  · intro every
    exact every .next_pc
...
@[simp] theorem comparisonRule_holds_iff (inputs : inputMap.Values)
  ...
  simp only [Silean.Contracts.Cycle.CycleOutputRule.Holds, comparisonRule,
    Silean.SignalGroup.fromLabels_matches_iff]
  constructor
  · intro every
...
@[simp] theorem writebackRule_holds_iff (inputs : inputMap.Values)
  ...
  simp only [Silean.Contracts.Cycle.CycleOutputRule.Holds, writebackRule,
    Silean.SignalGroup.fromLabels_matches_iff]
  constructor
  · intro every
