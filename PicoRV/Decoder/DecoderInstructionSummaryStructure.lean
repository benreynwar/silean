...
module_design Structure (name := "PicoRVDecoderInstructionSummary") where
  ...
  instances {
    recognized := Silean.Modules.Any.design 38,
    trap := Silean.Primitives.notDesign,
    luiAuipcJal := Silean.Modules.Any.design 3,
    arithmetic := Silean.Modules.Any.design 7,
    signedCompare := Silean.Modules.Any.design 3,
    unsignedCompare := Silean.Modules.Any.design 3,
    unsignedLoad := Silean.Modules.Any.design 3,
    compare := Silean.Modules.Any.design 5 }
  wiring {
  outputs {
