...
def resetMatchCombiner : Silean.Composition.SignalCombiner := .vector 23 .bit
def retainedMatchCombiner : Silean.Composition.SignalCombiner := .vector 15 .bit
def ordinarySummaryCombiner : Silean.Composition.SignalCombiner := .vector 4 .bit
def resetMatchSplitter : Silean.Composition.SignalSplitter := .vector 23 .bit
def retainedMatchSplitter : Silean.Composition.SignalSplitter := .vector 15 .bit
def ordinarySummarySplitter : Silean.Composition.SignalSplitter := .vector 4 .bit
...
module_design ResolveStage where
  ...
  instances {
    pseudoInverter := Silean.Primitives.notDesign,
    triggerEnable := Silean.Primitives.andDesign,
    resetInverter := Silean.Primitives.notDesign,
    ...
    resetMatchStorage := Silean.Modules.EnabledResetRegister.design
      ResolveStage.resetMatchType ResolveStage.falseResetMatches,
    retainedMatchStorage := Silean.Modules.EnabledRegister.design ResolveStage.retainedMatchType,
    immediateStorage := Silean.Modules.EnabledRegister.design ResolveStage.immediateType,
    ordinarySummaryStorage := Silean.Modules.Register.design ResolveStage.ordinarySummaryType,
    addSubSummaryStorage := Silean.Modules.Register.design .bit,
    compareStorage := Silean.Modules.ResetRegister.design .bit false,
    immediateSelection := Silean.Modules.Mux.design ResolveStage.immediateType,
    addSubSummarySelection := Silean.Modules.Mux.design .bit,
    compareSelection := Silean.Modules.Mux.design .bit,
    ...
    falseValue := Silean.Modules.Constant.design .bit false }
  wiring {
  outputs {
  ...
  instance (.resetMatchNext) {
    index := from (Silean.SignalSource.castType
