...
namespace PicoRV.Decoder.InstructionMatch
...
module_design Structure (name := "PicoRVDecoderInstructionMatch") where
  ...
  instances {
    ...
    immediateShift01 := Silean.Primitives.orDesign,
    immediateShiftGroup := Silean.Primitives.orDesign,
    arithmetic01 := Silean.Primitives.orDesign,
    arithmetic23 := Silean.Primitives.orDesign,
    arithmetic45 := Silean.Primitives.orDesign,
    arithmetic0123 := Silean.Primitives.orDesign,
    arithmetic012345 := Silean.Primitives.orDesign,
    immediateArithmeticGroup := Silean.Primitives.orDesign,
    registerShift01 := Silean.Primitives.orDesign,
    registerShiftGroup := Silean.Primitives.orDesign }
  wiring {
  outputs {
...
end PicoRV.Decoder.InstructionMatch
